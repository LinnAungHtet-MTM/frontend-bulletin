...
import { CalendarDays, ChevronLeft, Loader } from "lucide-react";
    ...
    <>
      ...
      shadow-[0_20px_50px_rgba(0,0,0,0.1)] p-6 sm:p-8"
              ...
              focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0"
                      ...
                      <div className="flex flex-col md:flex-row items-center gap-6 mt-8 border-white/30">
                        <div className="flex items-center gap-5 w-full">
                          <div className="">
                            ...
                            <Input
                              {...register("profile")}
                              type="file"
                              className="w-full max-w-[250px] cursor-pointer bg-white/50 shadow-sm text-xs"
                              onChange={(e) => {
                                if (e.target.files?.[0]) {
                                  setProfilePreview(
                          ...
                          <Avatar className="w-20 h-20 sm:w-24 sm:h-24 border-2 border-dashed border-slate-300 bg-slate-50 shadow-inner shrink-0">
                            <AvatarImage
                              src={profilePreview || undefined}
                              className="object-cover"
                            />
                            <AvatarFallback className="bg-slate-100 text-slate-400">
                              <div className="flex flex-col items-center justify-center scale-75 sm:scale-100">
                                <svg
